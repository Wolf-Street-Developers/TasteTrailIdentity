    ...
    public partial class Init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MenuItemLikes", x => x.Id);
                    table.ForeignKey(
                        name: "FK_MenuItemLikes_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MenuItemLikes_MenuItems_MenuItemId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FeedbackLikes_FeedbackId_UserId",
                table: "FeedbackLikes",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MenuItemLikes_MenuItemId_UserId",
                table: "MenuItemLikes",
                columns: new[] { "MenuItemId", "UserId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_MenuItemLikes_UserId",
                table: "MenuItemLikes",
                column: "UserId");
